...
#line 8
 testRunner.And("Click on below link and login to open edit input tab of other\'s private model", ((string)(null)), table154, "And ");
#line 12
...
#line 16
 testRunner.And("Click on below link and login to open View Analysis tab of other\'s private model", ((string)(null)), table155, "And ");
#line 20
 testRunner.Then("Verify edit input tab And logout from DCM and Okta.", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
...
#line 24
 testRunner.And("Click on below link and login to open Sensitivity Analysis tab of other\'s private" +
                    " model", ((string)(null)), table156, "And ");
#line 28
 testRunner.Then("Verify edit input tab And logout from DCM and Okta.", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
...
#line hidden
            ...
            table158.AddRow(new string[] {
                        "https://dcmqa.evhc.net/v2/input?modelId=4258"});
#line 44
 testRunner.And("Click on below link and login to open edit input tab using Viewer role", ((string)(null)), table158, "And ");
#line 48
 testRunner.Then("Verify edit input tab And logout from DCM and Okta.", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
...
#line hidden
            ...
            table159.AddRow(new string[] {
                        "https://dcmqa.evhc.net/v2/analysis?modelId=4295"});
#line 52
 testRunner.And("Click on below link and login to open View Analysis tab using Viewer role", ((string)(null)), table159, "And ");
#line 56
 testRunner.Then("Verify edit input tab And logout from DCM and Okta.", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
...
#line hidden
            ...
            table160.AddRow(new string[] {
                        "https://dcmqa.evhc.net/v2/sensitivityanalysis?modelId=4258"});
#line 60
 testRunner.And("Click on below link and login to open Sensitivity Analysis tab using Viewer role", ((string)(null)), table160, "And ");
#line 64
 testRunner.Then("Verify edit input tab And logout from DCM and Okta.", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
...
#line hidden
            ...
            table161.AddRow(new string[] {
                        "https://dcmqa.evhc.net/v2/executivesummary?modelId=4258"});
#line 68
 testRunner.And("Click on below link and login to open Executive Summary tab using Viewer role", ((string)(null)), table161, "And ");
#line 72
 testRunner.Then("Verify edit input tab And logout from DCM and Okta.", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
